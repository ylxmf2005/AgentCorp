...
Keep protocol fields, `artifact_type`, the `status` enum, paths, code identifiers, and API/interface contract fields at their literal values; write human-facing explanatory prose in zh-CN.
