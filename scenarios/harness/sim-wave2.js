...
hidden/sponsor-answers.md: spec 就是权威,不许改给定测试;超时语义按 spec 图;性能不是本轮验收项;无并发要求(单线程语义即可)。`,
    ...
    oracle_focus: 'D5-positive (heavy paradigm is CORRECT here — flag if pipeline goes light), D3 (test-planner rewriting provided authoritative tests), D7 (spec diagram semantics digested vs from-memory implementation)',
  },
  {
