...
- 将本 phase 的 artifact 写入 `output_path`。若设计需要产出多个 artifact，assignment 的 `output_path` 应指向 `design/` 目录；在其下按需创建 `architecture.md`、`impact-analysis.md`、`diagnosis.md`、`api-contract.md`。
